      ...
      <div className="customize-layout">
        ...
        <aside className="customize-preview">
          <div className="preview-card">
            <div className="preview-banner" style={{ background: headerTopic.field, color: headerTopic.ink }}>
              <TopicMotif name={headerTopic.motif} />
            </div>
        ...
        <form className="customize-form" onSubmit={submit}>
          ...
          <section className="form-block">
            ...
            <p className="form-note">These decide what we put in front of you.</p>
              ...
              {TOPIC_KEYS.map(key => {
                ...
                return (
                  <button
                    ...
                    aria-pressed={on}
                    style={on ? { background: topic.chip, borderColor: topic.chipInk, color: topic.chipInk } : undefined}
